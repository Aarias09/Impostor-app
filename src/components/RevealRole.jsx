// Importa React y los hooks useState y useEffect para manejar estado y efectos
...
export default function RevealRole({ playerName, playerIndex }){
	...
	// Efecto que se ejecuta cuando cambia el playerIndex o playerName
	// Resetea el estado revealed a false para que cada nuevo jugador empiece sin revelar
	useEffect(() => {
		setRevealed(false)
